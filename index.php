...
<head>
  ...
  <meta content="Hébergez votre site web avec Bees Tech : rapidité, sécurité, fonctionnalités avancées. Profitez de PHP, MySQL et SSL gratuitement. Certificat SSL gratuit pour une protection renforcée. Faites décoller vos projets en ligne dès maintenant !" name="description">
  ...
  <meta name="og:description" content="Optez pour Bees Tech, votre partenaire d'hébergement web ultrarapide, sécurisé et riche en fonctionnalités, le tout gratuitement ! Profitez de PHP, MySQL et SSL sans frais. Hébergez votre site web dès maintenant avec Bees Tech et donnez vie à vos projets en ligne. 🐝">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#decouvrir">Hébergement gratuit</a></li>
          <li><a class="nav-link scrollto " href="#hebergement-premium">Hébergement premium</a></li>
          <li><a class="nav-link scrollto" href="#faq">F.A.Q.</a></li>
          <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
          <li><a class="getstarted scrollto" href="https://my.beestech.fr">Espace client</a></li>
        </ul>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Hébergement web entièrement gratuit</h1>
          <h2>PHP, MySQL, SSL/HTTPS et pleins d'autres outils... <strong>SANS PUBLICITÉS</strong></h2>
          <div><a href="#decouvrir" class="btn-get-started scrollto">Découvrir</a></div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="assets/img/hero-img.png" class="img-fluid animated" alt="Image d'arrière plan">
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="decouvrir" class="about">
      <div class="container">

        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
            <img src="assets/img/about.jpg" class="img-fluid" alt="Personnes devant un écran violet">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Un service de qualité</h3>
            <p class="fst-italic">
              Nous vous fournissons des outils de pointe pour vous offrir un service de qualité.
            </p>
            <ul>
...
?>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Nos services</h2>
          <p>Découvrez ce qui fait de nous, un hébergeur de si spécial</p>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4>Hébergement rapide</h4>
              <p>Nos serveurs sont optimisés avec des disques durs <strong>SSD</strong>, pour que votre site soit le plus rapide possible</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <p>Nous vous fournissons des outils et des tutoriels pour que votre site soit <strong>le plus sécurisé</strong> possible</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4>99.9% d'uptime</h4>
              <p>Nos différentes maintenances n'impactent pas votre site, de ce fait celui ci est <strong>toujours en ligne</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <p>Notre partenaire <strong>Site.pro</strong> vous permet de créer votre site sans savoir coder en HTML</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4>Support 24/7</h4>
              <p>Notre équipe de support bénévole est là pour vous répondre à <strong>n'importe quelle heure de la journée</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <p>Notre interface de gestion <strong>cPanel</strong> vous offre tous les outils nécessaires au bon développement de votre site</p>
            </div>
          </div>
    ...
    <!-- ======= Features Section ======= -->
    <section id="autres-fonctionnalites" class="features">
      <div class="container" data-aos="fade-up">

        <div class="section-title">
          <h2>Autres fonctionnalités</h2>
          <p>Ce n'est pas tout, nous avons encore d'autres fonctionnalités dans notre poche !</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column align-items">
            <div class="icon-box mt-5 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4>Accès FTP</h4>
              <p>Pratique pour pouvoir transférer des fichiers sur votre site</p>
            </div>
            ...
            <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4>Statistiques</h4>
              <p>Idéal pour mesurer votre traffic web</p>
            </div>
          </div>
          <div class="image col-lg-6 order-1 order-lg-2 " data-aos="zoom-in" data-aos-delay="100">
            <img src="assets/img/features.svg" alt="Ensemble de fonctionnalités" class="img-fluid">
          </div>
        </div>
    ...
    <!-- ======= Pricing Section ======= -->
    <section id="hebergement-premium" class="pricing section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="box featured">
              <h3>Starter</h3>
              <h4>0<sup>€</sup><span> / mois</span></h4>
              <ul>
                <li>5 Go de stockage</li>
                <li>PHP 8.2</li>
                <li>400 bases de données</li>
                <li>Accès FTP</li>
                <li>Gestion DNS</li>
                <li class="na">Support prioritaire</li>
                <li class="na">cPanel Premium</li>
                <li class="na">Serveurs premium</li>
                <li class="na">MySQL distant</li>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              ...
              <h3>Ultimate</h3>
              <h4><sup>$</sup>6.90<span> / mois</span></h4>
              <ul>
                <li>Stockage illimité</li>
                <li>PHP toutes versions</li>
                <li>Bases de données illimitées</li>
                <li>Accès FTP</li>
                <li>Gestion DNS</li>
                <li>Support dédié</li>
                <li>cPanel Premium</li>
                <li>Serveurs premium</li>
                <li>MySQL distant</li>
                <li>Webmail</li>
              </ul>
              <div class="btn-wrap">
    ...
    <section id="faq" class="faq">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Vous avez une question ? La réponse se trouve peut être ici</p>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Autres liens</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="https://status.beestech.fr">Statut de services</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li>
                <a href="//www.dmca.com/Protection/Status.aspx?ID=b9fd06a1-d5ed-4d1c-a2d2-03b84709e57a" title="DMCA.com Protection Status" class="dmca-badge">
                  <img src ="https://images.dmca.com/Badges/dmca_protected_26_120.png?ID=b9fd06a1-d5ed-4d1c-a2d2-03b84709e57a"  alt="DMCA.com Protection Status" />
                </a>
              </li>
            </ul>
          </div>
